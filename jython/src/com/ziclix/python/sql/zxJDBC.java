 ...
 *
 * $Id: zxJDBC.java 5723 2008-12-09 08:45:33Z pjenvey $
 *
...
public class zxJDBC extends PyObject implements ClassDictInit {
    ...
    public static void classDictInit(PyObject dict) {
        ...
        dict.__setitem__("__version__", Py.newString("$Revision: 5723 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
