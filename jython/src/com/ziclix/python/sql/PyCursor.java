 ...
 *
 * $Id: PyCursor.java 5609 2008-11-23 04:18:48Z pjenvey $
 *
...
public class PyCursor extends PyObject implements ClassDictInit, WarningListener {
  ...
  static public void classDictInit(PyObject dict) {
    ...
    dict.__setitem__("__version__", Py.newString("$Revision: 5609 $").__getslice__(Py.newInteger(11), Py.newInteger(-2), null));
