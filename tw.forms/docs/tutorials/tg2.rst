...
Using twForms with TurboGears 2
================================

.. note::

   This tutorial has been shamelessly stolen from
   http://docs.turbogears.org/2.0/RoughDocs/ToscaWidgets/Forms ;)
...
.. note::
   ...
   Using a master template to inject resources will soon be deprecated and this
   tutorial will need updating. Check out :ref:`pylons_tutorial_two` to see
   how easy the new methods makes it (Pylons and TG2 share so many similarities
   that these two tutorials could be merged)
...
Run the application, surf to http://localhost:8080/new_form/ You will see a
form that looks like this:


.. image:: ./movie_form.png
...
.. currentmodule:: tw.forms.calendars
